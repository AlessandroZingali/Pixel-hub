        ...
        if($num > 0){
            $service=("Utente già registrato!");
                ...
                if($_COOKIE['tipoSignIn'] == "2" && $unlock == 0) $service="Chiave di registrazione errata! Contattare la segreteria al numero +3906061225587";
                        ...
                        VALUES
                        ('{$_POST['Nome']}','{$_POST['Cognome']}','{$_POST['Email']}','{$_POST['Password']}','{$_POST['Nickname']}','{$_POST['DataNascita']}', 3, 0, 0, 0,'ProfilePic/propicblank.png')";
                        ...
                        VALUES
                        ('{$_POST['Nome']}','{$_POST['Cognome']}','{$_POST['Email']}','{$_POST['Password']}','{$_POST['Nickname']}','{$_POST['DataNascita']}', 3, 0, 0, 1,'ProfilePic/propicblank.png','{$_POST['PIVA']}')";
                        setcookie('tipoSignIn', "", time() - 3600);
                        }
